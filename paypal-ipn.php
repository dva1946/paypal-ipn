...
?>
    <br>PP->TOP OF LOCAL IPN TEST PROCESS! -> <a href="index.php/local-test/"><b>IPN Local Test</b></a><br>
<?php
...
$my_email_addresses = array("fillinyourinfo@yourdomain.com");
...
echo "PP-3a1->Local Valid = $local_ver<br>";
echo "PP-3b1->Local InValid = $local_ver<br>";
echo "PP-3c1->Sim Valid = $sim_ver<br>";
echo "PP-3d1->Sim InValid = $sim_ver<br>";
...
list($verified, $logfile, $data_text) = $ipn->verifyIPN($test_local); 
