...
echo "IPN-1a1-> Inside function: $this->test_location<br>";
...
echo "IPN-1b1->USE SIMULATOR IPN TEST<br>"; 
...
echo INVALID;
echo  "<br>";  
echo "8:24PM STOPPING HERE ON RE-TESTING 09-24-22, PUZZLED!<br>";

echo "<br>Above is with defining function<br>";  
